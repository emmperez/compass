    ...
    return (
        <div className="about" ref={container}>
                ...
                <div className="relative w-full h-full">
                    ...
                    <div className="hero relative w-full h-full">
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center w-full max-w-[1200px] px-4 z-10">
                            ...
                            <p className="z-10 text-white text-[1rem] xl:text-[2rem] font-thin mt-2 max-w-[800px] mx-auto">COMPASS&reg; is your guide to wellness, personal growth, and mindful living. Explore insights, stories, and practical advice to help you navigate life with clarity and purpose.</p>
                        </div>
                        <Image 
            ...
            <section className="intro relative flex items-center px-[2em] xl:px-[4em] min-h-[100vh] mx-auto bg-[#fbc1d4] py-4">
                <div className="intro_info mx-auto w-full">
                    ...
                    <div className="card relative h-[300px] lg:min-h-[400px] lg:h-auto" key={`card-${idx}`}>
                        <div className="card-inner relative will-change-transform w-full h-full lg:min-h-[400px]  py-[2em] px-[2em] xl:px-[4em] flex lg:flex-row lg:gap-[4em] lg:justify-between lg:max-w-[1200px] xl:max-w-[100%] lg:mx-auto lg:py-[4em] xl:gap-[4em] flex-col xl:flex-row xl:justify-between" style={{ backgroundColor: card.backgroundColor }}>
                            <div className="card-content flex-1 xl:max-w-[60%]">
                                ...
                                <p className="xl:text-xl text-pretty" style={{ color: card.textColor }}>{card.description}</p>
                            </div>
                            <div className="card-img relative w-[30%] ratio-16/9 rounded-xl overflow-hidden">
                                <Image 
                                    src={card.image} 
                                    alt={card.title} 
                                    fill
            ...
            <section className="outro relative w-full h-[100vh] flex items-center p-[2em] lg:p-[4em] xl:p-[8em] bg-white flex-wrap xl:flex-nowrap">
                <h2 className="text-[2rem] lg:text-[3rem] xl:text-[4rem] font-bold leading-none mb-4 xl:mb-16">Why COMPASS&reg;?</h2>
                <p className="text-[1rem] lg:text-[1.5rem] xl:text-[2rem] font-thin mx-auto text-pretty mb-8 xl:px-8">Life doesn&rsquo;t come with a map, but with the right tools and perspectives, you can navigate it with confidence. We believe that everyone&rsquo;s path is unique, and our content is designed to meet you wherever you are on your journey. Whether you&rsquo;re looking for motivation, wellness tips, or just a fresh perspective, COMPASS&reg; is here to guide you. Join us as we explore ways to live with purpose, cultivate well-being, and embrace every step of the journey.</p>
            </section>
        </div>
    );
}
